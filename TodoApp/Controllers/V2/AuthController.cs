...
public class AuthControllerV2: ControllerBase
{
    ...
    public AuthControllerV2(UserManager<IdentityUser> userManager, IOptionsMonitor<JwtConfig> optionsMonitor,
        TokenValidationParameters parameters, ApiDbContextV2 context)
    {
    ...
    private async Task<AuthResult> VerifyAndGenerateToken(TokenRequest tokenRequest)
    {
        ...
        try
        {
            ...
            var storedToken =
                await _context.RefreshTokensV2.FirstOrDefaultAsync(x => x.Token == tokenRequest.RefreshToken);
            ...
            _context.RefreshTokensV2.Update(storedToken);
    ...
    private async Task<AuthResult> GenerateToken(IdentityUser user)
    {
        ...
        await _context.RefreshTokensV2.AddAsync(refreshToken);
        await _context.SaveChangesAsync();
        return new AuthResult()
        {
            Token = jwtToken,
